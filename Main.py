...
var2 = ['I was created by Gulab Brar right in his computer.', 'Gulab Brar']
...
songs = [
    'Keane_-_Somewhere_Only_We_Know_(Jesusful.com).wav',
    'Olivia_Rodrigo_-_Drivers_License.wav',
    'SALES_-_Pope_Is_a_Rockstar.wav',
    'Sean Kingston  Justin Bieber - Eenie Meenie(audiosong.in).wav',
    'Tattoo.wav'
]
